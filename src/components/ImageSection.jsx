  ...
  return (
    <div className="image-section">
      <div className="image-row">
        <div onClick={handleCardClick}  className="image-wrapper large">
        ...
        <div onClick={handleCardClick} className="image-wrapper small">
      ...
      <div onClick={handleCardClick}  className="image-row">
        ...
        <div onClick={handleCardClick} style={{paddingLeft:'20px'}} className="image-wrapper large">
